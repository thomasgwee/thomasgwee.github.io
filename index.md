...
- **Tools:** Git, GitHub, Docker, DBeaver
  ...
  <img src="https://skillicons.dev/icons?i=html,css,js,vue,react,ts,git,python,php,java,golang,docker,springboot,redis&theme=light" alt="Tech Skill Icons" />
...
📌 **Key Contributions:**
- Designed frontend interfaces and backend page structures using **React Native**.
